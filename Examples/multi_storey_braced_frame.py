...
t1 = stx.TrussElement(n1, n6, section)
t2 = stx.TrussElement(n5, n2, section)
t3 = stx.TrussElement(n2, n7, section)
t4 = stx.TrussElement(n6, n3, section)
t5 = stx.TrussElement(n3, n8, section)
t6 = stx.TrussElement(n7, n4, section)
