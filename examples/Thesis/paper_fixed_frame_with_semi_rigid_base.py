...
# spring elements
s1 = stx.LinearRotationalSpringElement(node_1, node_111, ks)
s2 = stx.LinearRotationalSpringElement(node_7, node_77, ks)
...
#
# range_ks_kc = np.arange(start=0, stop=20.1, step=0.1)
# r_list = []
#
# for ratio in range_ks_kc:
#     s1.rotational_stiffness = ratio * kc
#     s2.rotational_stiffness = ratio * kc
